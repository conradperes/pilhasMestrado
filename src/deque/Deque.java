...
public class Deque {
	...
	/**
	 * Permite ao usuário escolher entre Pilha Sequencial ou Encadeada, pode ser
	 ...
	 * 4- E o último recebe o auxiliar, ou seja, o índice atual, então isso acontece recursivamente
	 *  até que o índice seja zero e o tamanho do vetor seja zero 
	 * Complexidade O(N)
	 * 
	 ...
	 * letra b 
	 * Complexidade O(N)
	 * @param fila    Fila que será usada como parâmetro para a inversão de elementos
	 * @param fila2 Fila que servirá de estrutura auxiliar para inverter os elementos
	 * @return Array de Strings com os elementos invertidos
	 * @throws EmptyStackException
	 */
